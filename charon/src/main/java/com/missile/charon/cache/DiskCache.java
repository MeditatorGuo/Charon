...
import com.missile.charon.cipher.MD5;
import com.missile.charon.utils.AppUtil;
...
public class DiskCache implements ICache {
    ...
    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, Configure.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, Configure.CACHE_DISK_DIR)));
    }
    ...
    public void put(String key, Object value) {
        put(key, value != null ? JsonUtil.gson().toJson(value) : null);
    }
