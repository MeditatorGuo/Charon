...
import com.uowee.charon.BuildConfig;
...
public final class Logger {
    ...
    private static String mFolderName = Environment.getExternalStorageDirectory() + File.separator + "Charon"
    ...
    public static void logException(String aTag, Exception aException) {
        try {
            ...
            Logger.d(aTag, "========================= Exception Happened !!================================");

            Logger.d(aTag, aException.getMessage());
            StackTraceElement[] stack = aException.getStackTrace();
            //			if (null == stack) { //FindBugs
            //				return;
            //			}
            for (int i = 0; i < stack.length; i++) {
                Logger.d(aTag, stack[i].toString());

            }

            Logger.d(aTag, "========================= Exception Ended !!================================");
    ...
    public static void printInvokeTrace(String aTag) {
        ...
        for (int i = 1; i < stackTrace.length; i++) {
            Logger.d(aTag + ":  " + stackTrace[i].toString());
        }
    }
